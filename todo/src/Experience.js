...
/////////////////////////로그인 권한 주기//////////////////////
    React.useEffect(() => {
        Axios.get('http://ec2-3-34-125-91.ap-northeast-2.compute.amazonaws.com/mysite/experience/', {
            headers: {
    ...
    //   console.log(e);
      setState({
        visible: false,
            ...
            //////////////입력값 post하고 사이트에 띄우기////////////////
    Axios.post('http://ec2-3-34-125-91.ap-northeast-2.compute.amazonaws.com/mysite/experience/', exp)
    .then(res => {
        return Axios.get('http://ec2-3-34-125-91.ap-northeast-2.compute.amazonaws.com/mysite/experience/')
    }).catch(error => {        
        }).then (res => {
            const{data} = res
            setInfo(data)
...
/////////////////////////값 삭제하기/////////////////////////
    const deletelist = (id) => {
        Axios.delete('http://ec2-3-34-125-91.ap-northeast-2.compute.amazonaws.com//mysite/experience/'+id)
    .then(res => {
        return Axios.get('http://ec2-3-34-125-91.ap-northeast-2.compute.amazonaws.com/mysite/experience/')
    }).catch(error => {        
        }).then (res => {
